  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 h-screen flex flex-col justify-center overflow-hidden">
         ...
         <div className="absolute top-10 md:top-20 w-full px-6 md:px-16 flex justify-between items-center z-20 pointer-events-none">
              ...
              return (
                <div key={index} className="relative w-screen h-full flex flex-col justify-center px-6 md:px-16 lg:px-[10vw]">
                   ...
                   <div className="relative z-10 max-w-4xl flex flex-col">
                      ...
                      <h3 className="text-5xl md:text-7xl lg:text-[7rem] font-bold tracking-tighter text-white mb-8 md:mb-12 leading-[1.1] drop-shadow-2xl">
                        {service.title}
                      </h3>
                      ...
                      <div className="flex flex-col md:flex-row gap-8 md:gap-16 lg:gap-24 items-start md:items-center">
                        ...
                        <a 
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="flex-shrink-0 inline-flex items-center gap-3 px-8 py-5 rounded-full bg-white text-black hover:bg-green-500 hover:text-white transition-all duration-300 font-bold text-sm md:text-lg shadow-[0_0_30px_rgba(255,255,255,0.1)] hover:shadow-[0_0_40px_rgba(34,197,94,0.4)] hover:scale-105 group"
                        >
